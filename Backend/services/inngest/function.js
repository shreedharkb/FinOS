...
import EmailTemplate from "@backend/services/emails/template";
...
function isTransactionDue(transaction) {
  ...
  return new Date() >= new Date(transaction.nextRecurringDate);
}
...
async function generateFinancialInsights(stats, month) {
  ...
  const prompt = `
    ...
    Focus on spending patterns and offer practical advice.
